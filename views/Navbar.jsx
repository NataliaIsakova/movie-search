      ...
      <div className="container-fluid">
        ...
        {login ? (
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form name="searchForm" className="d-flex" role="search">
              <input name="getInfo" className="form-control me-2 searchInput" type="search" placeholder="Search" aria-label="Search" />
          ...
          : (
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/regist">ЗАРЕГИСТРИРОВАТЬСЯ</a>
                </li>
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ВЫБРАТЬ ФИЛЬМ ПО ЖАНРУ
